...
![Two-stage PV inverter with LCL filter, image taken from @zhao2022impedance.](sections/Elements/pictures/RES/PV_inverter.png){#fig-pv-inverter width=100%}
...
![Small-signal model in the dq-frame for the two-stage PV inverter shown in Fig. @fig-pv-inverter, image taken from @zhao2022impedance.](sections/Elements/pictures/RES/PV_inverter_small_signal_model.png){#fig-pv-small-signal-model width=100%}
...
The results of the code execution in Harmony are available in Fig. \ref{fig:PV_bode}. The parameters used for simulation are:
...
![Bode plots of the dq admittance for the PV inverter.](sections/Elements/pictures/RES/PV_bode_plots.png){#fig-PV_bode width=100%}

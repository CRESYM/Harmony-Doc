...
![Impedance model](assets/impedance_model.jpg){#fig-impedance_model fig-alt="Impedance model" width="200px"}
...
In (\ref{eq:1}), $n$ is several phases.  It must be noted here that the Y matrix is defined as a diagonal one as it is assumed that no mutual couplings exist between the three phases.

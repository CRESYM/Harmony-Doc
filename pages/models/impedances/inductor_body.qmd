...
1. **Frequency-Domain (Y-Parameter based)** â€?used for steady-state AC analysis.
...
2. **Time-Domain (MNA-based)** â€?used for transient or general MNA analyses.
...
- There are three stator windings ( $a, b, c$) distributed 120Âº apart one from each other, each of them with equal parameters (i.e. same resistance, inductance...).

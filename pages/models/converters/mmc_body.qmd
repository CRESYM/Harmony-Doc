...
![AC and DC side impedance measurement configuration.](assets/Impedance%20Measurement%20Circuit%20Diagram%20(Paper).png){#fig-measurement_config width=80%}
...
![Steps performed for measuring AC-side impedance in the $dq$ frame.](assets/Impedance%20Measurement%20Flow%20Diagram%20(Paper).png){#fig-ac_measurement_steps width=80%}

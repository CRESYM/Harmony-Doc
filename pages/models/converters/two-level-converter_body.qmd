...
VSC can have square-mode operation, where each switch (IGBT) conducts for a half period, with the phase shift of $\frac{2\pi}{3}$ for each phase @anaya2014offshore. This modulation is no longer used because it cannot vary magnitude.

---
layout: page 
title: Swtich # be as specific as possible
...
- **Open State:** When a phase of the switch is \texttt{open}, it represents an open circuit. The Switch introduces no constraint or connection between its associated buses in this state. Consequently, no equations or auxiliary variables related to this open phase are added to the MNA matrix. This corresponds to a connection with zero admittance.

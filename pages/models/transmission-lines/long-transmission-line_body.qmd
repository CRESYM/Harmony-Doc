...
where: 
   ...
   - $R$ - is the resistance per unit length ($\Omega/\text{m}$);
   - $L$ - is the inductance per unit length ($\text{H}/\text{m}$);
   - $G$ - is the conductance per unit length ($\text{S}/\text{m}$);
   - $C$ - is the conductance per unit length ($\text{F}/\text{m}$);
